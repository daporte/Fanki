angular.module("productModule").controller("editProductController",editProductController);

editProductController.$inject = ["$scope", "$timeout", "productService", "requiredFieldValidationService_Product", ];

function editProductController($scope, $timeout, productService, requiredFieldValidationService_Product){
